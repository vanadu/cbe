      ...
      <section className={`${styles.home_bg} ${styles.section}` }>
        ...
        <div className={styles.home_expander}>
          ...
          <Expander
            ...
            title='inspire'
            text='Live music from one of the most inspirational stories in American&nbsp;history.'
            index={1}
            activeExpanderIndex={activeExpanderIndex}
            setActiveExpanderIndex={setActiveExpanderIndex}
            >
            <p className={styles.content_text}>About 100 years ago, a handful of musicians from the most impoverished and disadvantaged region in America created a sound that changed the course of popular music all over the world.</p>
